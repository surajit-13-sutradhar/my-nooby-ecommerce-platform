...
const LoginPage = () => {
	...
	return (
		<div className="flex flex-col justify-center py-4 sm:px-4 lg:px-8">
			...
			>
				<h2 className='mt-4 text-center text-4xl font-bold text-brightBlue-300'>Log into your account</h2>
			</motion.div>
			...
			>
				<div className='bg-gray-100 py-8 px-4 shadow sm:rounded-lg sm:px-10'>
						...
						<div>
							...
							<div className='mt-1 relative rounded-md shadow-sm'>
								...
								<input
									...
									rounded-md shadow-sm placeholder-gray-400 text-white-100 focus:outline-none focus:ring-brightBlue-400 focus:border-brightBlue-400 sm:text-sm'
					...
					<p className='mt-8 text-center text-sm text-gray-500 font-display'>
						Not a member?{" "}
						<Link to='/signup' className='font-semibold text-brightBlue-300 hover:text-brightBlue-300'>
